...
<body class="d-flex align-items-center justify-content-center min-vh-100 position-relative overflow-hidden">
    ...
    <div class="container text-center z-1">
        <h1 class="display-1 fw-bold text-gradient tech-font" style="font-size: 8rem;">403</h1>
        <h2 class="text-white mb-4">Unauthorized Action</h2>
        <p class="lead max-w-2xl mx-auto mb-5">.</p>
